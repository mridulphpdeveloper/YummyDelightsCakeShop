      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
           <h1>Yummy Delights CakeShop</h1>
    <p style="color: #555; font-family: 'Verdana', sans-serif; font-size: 1.25rem; font-weight: bold;">Discover our wide range of delicious cakes, crafted to satisfy every craving. Need something special? We also offer custom cakes, tailored just for you!</p>
  ...
  <div class="container div_zindex">
    ...
    <div class="row">
      <div id="testimonial-slider" class="owl-carousel owl-theme">
        <?php
        $sql_p = "SELECT yt.Testimonial, u.name AS UserName FROM ydcs_testimonial yt JOIN users u ON yt.UserEmail = u.email";

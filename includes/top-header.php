...
<?php if(strlen($_SESSION['login'])){   ?>
				...
				<?php } ?>
                    ...
                    <li><a href="aboutus.php"><i class="icon fa fa-info-circle"></i>About Us</a></li>
    <li><a href="contact.php"><i class="icon fa fa-envelope"></i>Contact Us</a></li>
 ...
 <li><a href="admin/index.php"><i class="fa fa-user-circle-o"></i>Admin</a></li> 

   ...
   <div class="container" style="margin-top: 5%; background-color: #f9f9f9; padding: 30px; border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
    <div class="row">
        <div class="col-md-8 offset-md-2 text-center">
            ...
            <a href="http://localhost/YummyDelightsCakeShop" class="btn btn-primary" style="padding: 10px 20px; font-size: 18px; font-weight: bold; border-radius: 25px;">Go Back to Shop</a>
        </div>
    </div>
</div>
                <?php

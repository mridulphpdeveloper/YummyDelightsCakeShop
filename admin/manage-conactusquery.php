...
$eid=intval($_GET['eid']);
$status=1;
$sql = "UPDATE ydcs_contactusquery SET status=:status WHERE  id=:eid";
...
<head>
	...
	<title>Yummy Delights CakeShop | Manage Queries   </title>
						...
						<button onClick="window.print()">Print Contact Queries</button>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from  ydcs_contactusquery ";
$query = $dbh -> prepare($sql);
$query->execute();

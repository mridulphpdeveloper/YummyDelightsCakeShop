	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM ydcs_employees WHERE national_id='$national_id' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = ($password1);
							$update = mysqli_query($con, "UPDATE ydcs_employees SET password='$pass' WHERE national_id='$national_id'");
							if($update){
